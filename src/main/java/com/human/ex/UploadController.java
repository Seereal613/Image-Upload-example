...
public class UploadController {
	...
	@RequestMapping(value = "/uploadForm3", method = RequestMethod.POST)
...
//	public ResponseEntity<String> uploadAjax(MultipartFile file) throws Exception, Exception {
//		System.out.println(file.getOriginalFilename());
...
//	}
	...
	@RequestMapping(value = "/uploadAjaxM", method = RequestMethod.GET)
	public void uploadAjaxM() {
	}

	@ResponseBody
	@RequestMapping(value = "/uploadAjaxM", method = RequestMethod.POST, produces = "text/plain;charset=UTF-8")
